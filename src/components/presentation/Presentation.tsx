...
export const Presentation = () => {
    ...
    return (
        <Container>
            ...
            <Description>
                Markdown Editor is a React project for editing Markdown, with emoji support, styling via Styled Components, and safe rendering using Rehype and Remark.            </Description>
